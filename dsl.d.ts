...
type SymbolRule<Name> = { type: "SYMBOL"; name: Name };
...
type GrammarSymbols<GrammarStruct> = {
  [name in keyof GrammarStruct]: SymbolRule<name>;
};

type RuleBuilder<GrammarStruct> = (
  $: GrammarSymbols<GrammarStruct>,
  previous: Rule,
) => RuleOrLiteral;

type RuleBuilders<
  GrammarStruct,
  ExternalGrammarStruct,
  BaseGrammarStruct,
  BaseExternalGrammarStruct,
> = {
  [name in keyof GrammarStruct]: RuleBuilder<
    GrammarStruct &
      BaseGrammarStruct &
      ExternalGrammarStruct &
      BaseExternalGrammarStruct
...
interface Grammar<
  ...
  BaseGrammarStruct = {},
  BaseExternalGrammarStruct = {},
  MergedGrammarStruct = GrammarStruct &
    ExternalGrammarStruct &
    BaseGrammarStruct &
    BaseExternalGrammarStruct,
> {
   ...
   */
  precedences?: (
    $: GrammarSymbols<MergedGrammarStruct>,
    previous: Rule[][],
  ) => RuleOrLiteral[][];
   ...
   */
  externals?: (
    $: { [name in keyof ExternalGrammarStruct]: SymbolRule<name> },
    previous: Rule[],
  ) => RuleOrLiteral[];
   ...
   *  @param $ grammar rules
   */
  extras?: ($: GrammarSymbols<MergedGrammarStruct>) => RuleOrLiteral[];
   ...
   */
  word?: ($: GrammarSymbols<MergedGrammarStruct>) => RuleOrLiteral;
}

type GrammarSchema<GrammarStruct, ExternalGrammarStruct> = {
  [K in keyof Grammar<GrammarStruct, ExternalGrammarStruct>]: Grammar<
    GrammarStruct,
    ExternalGrammarStruct
  >[K];
};
 ...
 */
type GrammarFunc<GrammarStruct, ExternalGrammarStruct = {}> = (
  options: Grammar<GrammarStruct, ExternalGrammarStruct>,
) => GrammarSchema<GrammarStruct, ExternalGrammarStruct>;
 ...
 */
type GrammarWithBaseFunc<
  GrammarStruct,
  GrammarExternalOrAliasStruct = {},
  BaseGrammarStruct = {},
  BaseGrammarExternalOrAliasStruct = {},
> = (
  ...
  GrammarStruct & BaseGrammarStruct,
  GrammarExternalOrAliasStruct & BaseGrammarExternalOrAliasStruct
>;
